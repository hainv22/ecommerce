                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group {{ $errors->first('tp_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" name="tp_name" class="form-control" value="{{ $transport->tp_name }}"  placeholder="Name ....">
                            ...
                            <div class="form-group {{ $errors->first('tp_fee') ? 'has-error' : '' }}" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="tp_fee" class="form-control price_format" value="{{ $transport->tp_fee }}">
                                </div>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <div class="form-group {{ $errors->first('tp_description') ? 'has-error' : '' }}">
                                ...
                                <textarea class="form-control" value="" name="tp_description" rows="5" placeholder="Enter ...">{{ $transport->tp_description }}</textarea>
