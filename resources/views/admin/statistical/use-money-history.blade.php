...
{{--                                    </select>--}}
                                    ...
                                    <select name="year_use_money" class="form-control">
                                        ...
                                        <option value="2025" {{ Request::get('year_use_money') == 2025 ? "selected='selected'" : "" }}>Năm 2025</option>
                                        <option value="2026" {{ Request::get('year_use_money') == 2026 ? "selected='selected'" : "" }}>Năm 2026</option>
                                    </select>
